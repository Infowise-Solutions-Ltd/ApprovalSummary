...
namespace Infowise.Sharepoint.V3.Fields
{
    ...
    {
        #region Constants
        static readonly string DirectoryKeyName = "SOFTWARE\\ApprovalSummary";
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (masterKey != null)
                    {
                        ...
                        catch (Exception) { m_EventViewer = false; }
        ...
        private static void LogToFile(string msg)
        {
            ...
            {
                if (LogFile != null)
                    LogFile.WriteLine(DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss:fff :: ") + msg);
            }
        }
        ...
        static private void Log(string msg, EventLogEntryType type)
        {
            try
            {
                if (Debug)
                {
                    if (m_EventViewer.Value)
                        EventLog.WriteEntry("ApprovalSummary.Audit", msg, type);
